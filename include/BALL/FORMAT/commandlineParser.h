#ifndef BALL_FORMAT_CMDPARSER_H
#define BALL_FORMAT_CMDPARSER_H
	...
	*/
	class BALL_EXPORT CommandlineParser
	{
		public:
			...
			void registerParameter(String name, String description, ParameterType type,
					                   bool mandatory = 0, String default_value = "");
